...
public class TestsShippingSockShopTest
{
    ...
    public void testPostShipping025(final JsonObject json) throws MalformedURLException, IOException
    {
        ...
        request2.setJsonBody("25/payload_for_endp_25.json", new Hashtable<String, Object>() {{
            put("$.id", uuidv4());
            put("$.name", name);
        }});
    ...
    @ParameterizedTest
    @JsonFileSource(resources = "/144/dataset_144.json")
    public void testPostShipping144(final JsonObject json) throws MalformedURLException, IOException
    {
        ...
        request.setJsonBody("144/payload_for_endp_144.json", new Hashtable<String, Object>() {{
            put("$.id", uuidv4());
            put("$.name", name);
        }});
